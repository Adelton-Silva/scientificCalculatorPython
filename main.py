...
#Now let's create a class in which we will 
#create all the scientific calculator functions 
#so that they can be called and executed easily.
class Calc():
    def __init__(self):
        self.total = 0
        self.current = ''
...
#The following code will create a screen in the calculator GUI,
#passing the font style, font size, background 
#color and foreground color as an argument inside the input function.
...
#here we will create a numerical keyboard for the calculator.
...
#Now let's place all the buttons/operators in their 
#respective positions in the grid. It's up to you to set 
#them as per your choice by changing their row and column values. 
# In this each button function is just taking the operator name, width, 
# height, background, foreground, font and respective column and row position 
...
#Now, finally, we'll create a calculator GUI menu bar.
